...
def main(argv=None):
    ...
    places =  set(range(81)) & set([n for n,p in enumerate(board) if p == 0 ])
...
'''
time python3 x.py master-boards.txt x_out.txt A1-1,Easy-NYTimes,unsolved
time python3 x.py master-boards.txt x_out.txt A2-1,Medium-NYTimes,unsolved
time python3 x.py master-boards.txt x_out.txt A3-1,Hard-NYTimes,unsolved
time python3 x.py master-boards.txt x_out.txt A4-1,WebSudoku-Hard,unsolved
time python3 x.py master-boards.txt x_out.txt A5-1,WebSudoku-Evil,unsolved
time python3 x.py master-boards.txt x_out.txt A6-1,hardest-sudoku-telegraph,unsolved
time python3 x.py master-boards.txt x_out.txt A7-1,sudokugarden_100sudoku2-Nr-100,unsolved
time python3 x.py master-boards.txt x_out.txt A8-1,sudokugarden_100sudoku2-Nr-50,unsolved
'''
